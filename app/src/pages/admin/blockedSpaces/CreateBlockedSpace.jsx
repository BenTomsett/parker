...
const CreateBlockedSpace = ({update}) => {
    ...
    return (
        <>
            <Button onClick={onOpen} colorScheme="blue" leftIcon={<FiPlus/>}>Restrict Space</Button>
...
export default CreateBlockedSpace;