module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    [
      ...
      {name: "New Science Car Park", numOfSpaces: 2, gpsPoint: Sequelize.fn('ST_GeomFromGeoJSON', JSON.stringify(cp2Point)), createdAt: new Date(), updatedAt: new Date()},
      {name: "Constable Terrace Car Park", numOfSpaces: 6, gpsPoint: Sequelize.fn('ST_GeomFromGeoJSON', JSON.stringify(cp3Point)), createdAt: new Date(), updatedAt: new Date()}
    ])
  },
